...
void Player::init(float speed, glm::vec2 pos, Adina::InputManager* inputManager, Adina::Camera2D* camera, std::vector<Bullet>* bullets) {
    _speed = speed;
    _position = pos;
    _inputManager = inputManager;
    _bullets = bullets;
    _camera = camera;
	_color = Adina::ColorRGBA8(255, 255, 255, 255);
    _health = 150;
	m_textureID = Adina::ResourceManager::getTexture("Textures/player.png").id;
}
